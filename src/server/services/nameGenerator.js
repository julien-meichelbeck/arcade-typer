...
const ADJECTIVES = ['attractive', 'sexy', 'auburn', 'average', 'bald', 'beautiful', 'big', 'black', 'blind', 'blond', 'blue', 'brown', 'brunette', 'clean', 'curly', 'angry', 'mad', 'sick', 'cute', 'dark', 'dirty', 'fat', 'foreign', 'green', 'grey', 'mysterious', 'hairy', 'handsome', 'heavy', 'hot', 'light-blue', 'long', 'old', 'orange', 'pale', 'pink', 'pregnant', 'pretty', 'purple', 'red', 'red-haired', 'short', 'skinny', 'dancing', 'small', 'tall', 'tan', 'thick', 'thin', 'ugly', 'wavy', 'white', 'wide', 'yellow', 'young']
